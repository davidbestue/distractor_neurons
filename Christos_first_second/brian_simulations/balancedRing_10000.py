...
N=10000 #10000 # total number of neurons
print(N)
...
if saveconnections:
  ...
  CIE = csr_matrix(C5.W)
  CII = csr_matrix(C6.W)
  np.savez_compressed('/home/david/Desktop/brian_simulations/connections_sp_10000', CEEd=CEE.data, CEEi=CEE.indices, CEEp=CEE.indptr, CEEs=CEE.shape,
