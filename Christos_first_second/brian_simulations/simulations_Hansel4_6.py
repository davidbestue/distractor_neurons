...
for extE in extEs:
	for pos in positions:
		for n in range(number_):
			results = run_simulation(IEext=extE, pos_stim=pos, paralel_simulation=False, path_='/home/david/Desktop/brian_simulations_albert/simulations7/')
