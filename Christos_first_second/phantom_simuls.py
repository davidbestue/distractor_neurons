...
ON_1_far = Parallel(n_jobs = numcores)(delayed(model)(totalTime=10000, targ_onset_1=1000, targ_onset_2=20000, angle_target_i=90, presentation_period=100,
...
OFF_1_far = Parallel(n_jobs = numcores)(delayed(model)(totalTime=10000, targ_onset_1=1000, targ_onset_2=20000, angle_target_i=90, presentation_period=100,
...
err1_on_f.to_excel('/home/david/Desktop/err1_on_f12.xlsx') #5sec for f7
...
err1_off_f.to_excel('/home/david/Desktop/err1_off_f12.xlsx')
