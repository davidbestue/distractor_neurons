...
ON_1_far = Parallel(n_jobs = numcores)(delayed(model)(totalTime=20000, targ_onset_1=100, targ_onset_2=1000, angle_target_i=90, presentation_period=100,
...
OFF_1_far = Parallel(n_jobs = numcores)(delayed(model)(totalTime=20000, targ_onset_1=100, targ_onset_2=1000, angle_target_i=90, presentation_period=100,
