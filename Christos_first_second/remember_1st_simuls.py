...
###
print('abs error OFF, close: ' + str(round(np.mean([abs(res_off_f[i]) for i in range(len(res_off_f))]),2) ) )
...
###
print('abs error ON, close: ' + str(round(np.mean([abs(res_on_f[i]) for i in range(len(res_on_f))]),2) ) )
